...
from backend.api.translation import translate_text, get_supported_languages, get_popular_languages, detect_language
                ...
                if st.button("Short Summary"):
                    try:
                        ...
                        if "user_id" in st.session_state:
                            save_to_history(st.session_state.user_id, text, summary, "summary", "short")
            ...
            with col2:
                if st.button("Medium Summary"):
                    try:
                        ...
                        # Save to history
                        if "user_id" in st.session_state:
                            save_to_history(st.session_state.user_id, text, summary, "summary", "medium")
            ...
            with col3:
                if st.button("Long Summary"):
                    try:
                        ...
                        # Save to history
                        if "user_id" in st.session_state:
                            save_to_history(st.session_state.user_id, text, summary, "summary", "long")
            ...
            with col1:
                if st.button("Beginner (Conservative)", key="btn_beginner"):
                    ...
                    try:
                        ...
                        # Save to history
                        if "user_id" in st.session_state:
                            save_to_history(st.session_state.user_id, text, paraphrases[0], "paraphrase", "conservative")
            ...
            with col2:
                if st.button("Intermediate (Balanced)", key="btn_intermediate"):
                    ...
                    try:
                        ...
                        # Save to history
                        if "user_id" in st.session_state:
                            save_to_history(st.session_state.user_id, text, paraphrases[0], "paraphrase", "balanced")
            ...
            with col3:
                if st.button("Advanced (Creative)", key="btn_advanced"):
                    ...
                    try:
                        ...
                        # Save to history
                        if "user_id" in st.session_state:
                            save_to_history(st.session_state.user_id, text, paraphrases[0], "paraphrase", "creative")
